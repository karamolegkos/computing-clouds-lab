...
- Να εκτελέσετε εύκολα μια MySQL μέσω Docker.
- Να τη χρησιμοποιήσετε μέσα από το shell ή εξωτερικές εφαρμογές.
- Να κρατάτε μόνιμα τα δεδομένα σας μέσω volumes.